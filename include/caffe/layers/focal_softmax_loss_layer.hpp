...
class FocalSoftmaxLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit FocalSoftmaxLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "FocalSoftmaxLoss"; }
