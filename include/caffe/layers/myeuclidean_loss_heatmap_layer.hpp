#ifndef CAFFE_MYEUCLIDEAN_LOSS_LAYER_HPP_
#define CAFFE_MYEUCLIDEAN_LOSS_LAYER_HPP_
 ...
 * input to a MyEuclideanLossLayer exactly formulates a linear least squares
...
#endif  // CAFFE_MYEUCLIDEAN_LOSS_LAYER_HPP_
