#ifndef CAFFE_BALANCE_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_BALANCE_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
class BalanceCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
  explicit BalanceCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "BalanceCrossEntropyLoss"; }

 protected:
  /// @copydoc BalanceCrossEntropyLossLayer
...
#endif  // CAFFE_BALANCE_CROSS_ENTROPY_LOSS_LAYER_HPP_
