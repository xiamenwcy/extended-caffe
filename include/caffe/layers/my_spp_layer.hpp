#ifndef CAFFE_MySPP_LAYER_HPP_
#define CAFFE_MySPP_LAYER_HPP_
...
class MySPPLayer : public Layer<Dtype> {
 public:
  explicit MySPPLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "MySPP"; }
 ...
 protected:
  ...
  virtual LayerParameter GetPoolingParam(const int num_bins,
      const int bottom_h, const int bottom_w, const MySPPParameter spp_param);

  int pyramid_height_;
  vector<int> bin_size_;
